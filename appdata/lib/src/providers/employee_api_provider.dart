...
class EmployeeApiProvider {
  ...
  Future<List<Stateclass>> stateapimasterdata() async {
    Response response = await Dio().get("http://$ipAddress:8080/dLicence/api/states/v1");
  ...
  Future<List<Airline>> airlineapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/airline/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
    ...
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/countries/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
  ...
  Future<List<Doctor>> doctorNameapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/doctor/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
   ...
   Future<List<Institution>> institutionNameapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/institution/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
   ...
   Future<List<Language>> languageapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/languages/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
      DBProvider.db.languagedb(Language.fromJson(data));
    }).toList();
  } Future<List<Class>> classNameapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/licenseclass/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
      DBProvider.db.classNamedb(Class.fromJson(data));
    }).toList();
  } Future<List<Code>> codeapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/licensecodes/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
      DBProvider.db.codedb(Code.fromJson(data));
    }).toList();
  } Future<List<Titleclass>> titleapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/licensetitles/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
      DBProvider.db.titledb(Titleclass.fromJson(data));
    }).toList();
  } Future<List<Type>> typeNameapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/licensetype/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
      DBProvider.db.typeNamedb(Type.fromJson(data));
    }).toList();
  } Future<List<Limitation>> limitationINTmedicalapimasterdata() async {
    Response response =await Dio().get("http://$ipAddress:8080/dLicence/api/limitation/v1");
    return (response.data as List).map((data) {
      print('Inserting $data');
