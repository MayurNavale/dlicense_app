...
class ApplyEnrollPage extends StatefulWidget {
  @override
  _ApplyEnrollPage createState() =>  _ApplyEnrollPage();
  }
    class _ApplyEnrollPage extends State<ApplyEnrollPage> {
    ApplyEnrollClass applyEnrollClass= ApplyEnrollClass();
...
futuremedicalVal = getMedicaldata();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:  AppBar( title:  Text('Apply & Enroll'),centerTitle: true, ),
        body: Center(
