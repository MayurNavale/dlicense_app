...
//       entries.add(Instructorapi(examniaridval, idval, job));
//     }
...
//   Instructorapi(this.examinerTypeId, this.id, this.remark);

//   String toString() {
//     return 'examinerTypeId= $examinerTypeId, id= $id, remark= $remark';
//   }
//  factory Instructorapi.fromJson(dynamic json) {
//     return Instructorapi(json['examinerTypeId'] as String, json['id'] as int,json['remark'] as String,);
//   }
