...
//     return res;}
//  endorsementTypesdb(Endorsement newstatedata) async {
//      final db = await database;
//      final res = await db.insert('Endorsement', newstatedata.toJson());
//      return res;}
...
//  licensecodesdatalist = await db.rawQuery("SELECT * FROM CODE");print(licensecodesdatalist);
//   licensetypedatalist = await db.rawQuery("SELECT * FROM TYPE");print(licensetypedatalist);
//   licensetitlesdatalist = await db.rawQuery("SELECT * FROM TITLECLASS");print(licensetitlesdatalist);
//   limitationdatalist = await db.rawQuery("SELECT * FROM LIMITATION");print(limitationdatalist);
//   ministrydatalist = await db.rawQuery("SELECT * FROM MINISTRY");print(ministrydatalist);
//   niveauleveldatalist = await db.rawQuery("SELECT * FROM NIVEAULEVEL");print(niveauleveldatalist);
//   schooldatalist = await db.rawQuery("SELECT * FROM SCHOOL");print(schooldatalist);
//   examinerdatalist = await db.rawQuery("SELECT * FROM EXAMINER");print(examinerdatalist);
//   endorsementdatalist = await db.rawQuery("SELECT * FROM ENDORSEMENT"); print(endorsementdatalist);
